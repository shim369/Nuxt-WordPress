...
<template>
  ...
  <div class="max-w-[1200px] container mx-auto pt-[100px] p-5">
    ...
    <div class="flex gap-[3.3%] mt-10 flex-col sm:flex-row sm:flex-wrap">
      <NuxtLink v-for="post in data" :to="`/posts/${post.id}`" class="w-full sm:w-[30%] shadow rounded hover:opacity-80 mb-10">
